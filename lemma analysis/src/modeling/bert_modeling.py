"""
BERT Modeling Pipeline
Refactored from Bert_Phase_3_4.ipynb
"""
...
def train_bilstm(X, y, cv_splits, model_name="BERT", output_dir="Bert_Models",
...
def main():
    """Main execution function for BERT modeling."""
    print("=" * 70)
    print("BERT MODELING PIPELINE")
    print("=" * 70)
    
    # Load data
    print("Loading data...")
    with open("x_bert_1.pkl", "rb") as f:
        X = pickle.load(f)
    ...
    # Train models
    train_logistic_regression(X, y, cv_splits, "BERT", "Bert_Models")
    train_random_forest(X, y, cv_splits, "BERT", "Bert_Models")
    train_xgboost(X, y, cv_splits, "BERT", "Bert_Models")
    
    # Load sequence data for BiLSTM
    with open("x_bert_2.pkl", "rb") as f:
        X_seq = pickle.load(f)
    
    train_bilstm(X_seq, y, cv_splits, "BERT", "Bert_Models")
    
    print("\nBERT modeling complete!")
